...
set CLASSPATH=%CLASSPATH%;%LIBS%\fluent-hc-4.3.6.jar
set CLASSPATH=%CLASSPATH%;%LIBS%\httpclient-4.3.6.jar
set CLASSPATH=%CLASSPATH%;%LIBS%\httpclient-cache-4.3.6.jar
set CLASSPATH=%CLASSPATH%;%LIBS%\httpcore-4.3.3.jar
set CLASSPATH=%CLASSPATH%;%LIBS%\httpmime-4.3.6.jar
set CLASSPATH=%CLASSPATH%;%LIBS%\JSON4J.jar
set CLASSPATH=%CLASSPATH%;%LIBS%\wp.base.jar
set CLASSPATH=%CLASSPATH%;%LIBS%\wp.utilities.collections.jar
set CLASSPATH=%CLASSPATH%;%LIBS%\wp.scriptportlet.cmdln.jar


"%JAVA_HOME%\bin\java" -classpath "%CLASSPATH%" com.ibm.wps.scriptportlet.cmdln.CommandLine %*
goto end
